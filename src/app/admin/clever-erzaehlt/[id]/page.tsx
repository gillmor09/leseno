...
export async function generateMetadata({
  ...
  try {
    ...
    return {
      title: roman
        ? `${roman.title} — Clever erzählt`
        : "Clever erzählt — Leseno Admin",
    };
  } catch {
    return { title: "Clever erzählt — Leseno Admin" };
  }
}
 ...
 */
export default async function CleverErzaehltAdminDetailPage({
  params,
}: PageProps) {
  const { id } = await params;

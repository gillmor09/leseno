...
export const metadata: Metadata = {
  title: "Clever erzählt — Leseno Admin",
  description:
    "Bücher, die ein Wissensgebiet in mehreren Kurzgeschichten erzählen.",
};

const MODULE_ID: RomanAdminModuleId = "clever_erzaehlt";

/**
 * Admin index for Clever-erzählt books (knowledge via short stories).
 */
export default async function CleverErzaehltAdminPage() {
    ...
    if (!hasServiceRoleConfig()) {
      ...
      const message =
        error instanceof Error
          ? error.message
          : "Clever-erzählt-Modul nicht verfügbar.";
      ...
      <main id="main" className="flex-1">
        <section className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-14">
          ...
          <p className="mt-3 max-w-3xl text-base leading-relaxed text-zinc-600">
            Internes Werkzeug für Bücher, die ein Wissensgebiet in mehreren
            Kurzgeschichten erzählen. Buchtyp ist fest Clever erzählt —

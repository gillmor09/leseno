...
/** Short line under story results. */
export const SHARE_AFTER_STORY_HINT =
  "Gefällt die Geschichte? Empfiehl leseno einer anderen Familie — per Link, WhatsApp oder Instagram.";

/** Landing „Empfehlen“ section. */
...
export const SHARE_BUTTON_NATIVE = "Teilen";
export const SHARE_BUTTON_INSTAGRAM = "Für Instagram";
export const SHARE_BUTTON_WHATSAPP = "WhatsApp";

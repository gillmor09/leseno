...
/**
 * Confirm dialog for non-destructive actions (Abbrechen + primary confirm).
 * Close only after success-driven unmount or when idle cancel / X.
 */
    ...
    >
      ...
      >
        ...
        <p
          ...
          className="mt-3 whitespace-pre-line text-sm leading-relaxed text-zinc-600"
        >
          {description}
        </p>

                  ...
                  <div className="mt-6 grid gap-1.5">
                    {adminItems.map((item) => (
                      <a
                        ...
                        onClick={() => setAdminOpen(false)}
                        className={cn(
                          "rounded-xl border border-zinc-950/10 bg-gray-100 px-4 py-2 text-sm font-bold text-zinc-950 transition-all duration-200 ease-in-out hover:border-orange-300 hover:bg-orange-50",
                          pathname === item.href &&

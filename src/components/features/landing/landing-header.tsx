    ...
    <header className="sticky top-0 z-50 border-b border-zinc-950/10 bg-white/95 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-3 px-4 sm:px-6">
        ...
        <div className="flex shrink-0 items-center gap-2">
          {isSignedIn ? (
            <>
              {/* Full member nav from md up — on small screens it lives in the menu. */}
          ...
          {isSignedIn ? (
            <>
              ...
              <button
                ...
                onClick={handleSignOut}
                disabled={signingOut}
                className="mt-1 inline-flex items-center justify-center gap-2 rounded-full bg-zinc-800 px-4 py-2.5 text-sm font-bold text-white transition-all duration-200 ease-in-out hover:bg-zinc-900 disabled:opacity-70"
              >
